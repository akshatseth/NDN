...
class bikeGear(Sensor):
    ...
    def change_gear(self):
        while True:
            time.sleep(3)
            new_load = random.randint(0,5)
            self.gear+= new_load
            if self.gear>5:
                self.gear = 5
            print("Motorcycle running on gear {} \n".format(self.gear))
            time.sleep(7)
...
class bikePetrol(Sensor):
    ...
    def change_petrol(self):
        while True:
            ...
            if self.petrol <=0:
                self.petrol = 10
            print("Current petrol in the bike {} litres \n".format(self.petrol))
            time.sleep(4)
